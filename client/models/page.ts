...
// classes
// struct2ts:github.com/linkpoolio/marketplace/core/store/models/presenters.Page
class Page<T> {
    data: T;
    totalCount?: number;
    meta?: { [key: string]: any };
    ...
    constructor(data?: any) {
        ...
        this.data = ('data' in d) ? d.data as any : {};
        this.totalCount = ('totalCount' in d) ? d.totalCount as number : 0;
        this.meta = ('meta' in d) ? d.meta as { [key: string]: any } : {};
    }

    toObject(): any {
        const cfg: any = {};
        cfg.totalCount = 'number';
